# DEMO ERP — 자동차 제조 공정 최적화 통합 관리 시스템

AI를 활용해 질문하고 검증하여 만든 VB.NET WinForms 기반의 자동차 부품 제조 현장용 ERP 시스템입니다.
...
- **유지보수성 향상**: AI에게 아키텍처 개선 방향을 질문하고 검토한 뒤, 계층형 구조(UI/Services/Repositories 분리)를 직접 적용했습니다.
...
- **언어**: VB.NET (WinForms)
- **프레임워크**: .NET 5
- **데이터베이스**: SQLite (MS-SQL 전환 가능)
- **아키텍처**: 3계층 구조 (UI Layer / Service Layer / Repository Layer)
